...
where `orders`.ord_amount >= 1000 group by customer.cus_gender;
...
use e_commerce;
select product.pro_id, product.pro_name,orders.ord_date from `orders` inner join product_details on 
